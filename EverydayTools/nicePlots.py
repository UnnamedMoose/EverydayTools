...
def makeAxesNice(fig, ax, xlab='', ylab='', figtitle='', zlab="",
	...
	if axes3d:
		...
		# format grid lines
		ax.w_xaxis._axinfo.update({'grid' : {'color': (0, 0, 0, 0.5), 'linestyle': "--"}})
		ax.w_yaxis._axinfo.update({'grid' : {'color': (0, 0, 0, 0.5), 'linestyle': "--"}})
		ax.w_zaxis._axinfo.update({'grid' : {'color': (0, 0, 0, 0.5), 'linestyle': "--"}})
